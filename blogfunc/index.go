...
func indexdbquery() (string, string) {
	...
	i := 1
	container, _ := template.ParseFiles("gtpl/index-container.gtpl")
	primary, _ := template.ParseFiles("gtpl/index-primary.gtpl")
	for rows.Next() {
...
func Index(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	vars = isAjax(r, vars)
	index, _ := template.ParseFiles("gtpl/index.gtpl", "gtpl/header.gtpl", "gtpl/footer.gtpl")
